...
![](..\static\笔记图片\RibbitMQ\image-20190925215603036-9419777.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200311182438041.png)
...
#### 2.2.2 下载的安装包![](..\static\笔记图片\RibbitMQ\image-20190925220343521.png)
...
![](..\static\笔记图片\RibbitMQ\image-20190925222230260-3836271.png)

将上图中配置文件中红色部分去掉`%%`,以及最后的`,`逗号 修改为下图:

![](..\static\笔记图片\RibbitMQ\image-20190925222329200-3836312.png)
...
![](..\static\笔记图片\RibbitMQ\image-20190925222743776-3836511.png)
...
```
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20190926194738708-3836601.png)
...
![](..\static\笔记图片\RibbitMQ\image-20190926194954822-3836665.png)
...
![](..\static\笔记图片\RibbitMQ\image-20191126162026720.png)
...
![](..\static\笔记图片\RibbitMQ\image-20191126162617280.png)
...
```
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20191126163023153.png)
...
点击添加好的虚拟主机：
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20191126163506795.png)

进入虚拟机设置界面:

![](..\static\笔记图片\RibbitMQ\image-20191126163631889.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200312140114784.png)

### 4.1 RabbitMQ支持的消息模型

![](..\static\笔记图片\RibbitMQ\image-20191126165434784.png)

![](..\static\笔记图片\RibbitMQ\image-20191126165459282.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200314221002008.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200314223242058.png)

![](..\static\笔记图片\RibbitMQ\image-20200314223302207.png)
...
- 关闭消息的自动确认,开启手动确认消息
  ...
  ![](..\static\笔记图片\RibbitMQ\image-20200314230412178.png)

  ![](..\static\笔记图片\RibbitMQ\image-20200314230423280.png)
...
`fanout 扇出 也称为广播`
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20191126213115873.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200315180653207.png)

![](..\static\笔记图片\RibbitMQ\image-20200315180708489.png)

![](..\static\笔记图片\RibbitMQ\image-20200315180728035.png)
...
![](..\static\笔记图片\RibbitMQ\image-20191126220145375.png)
...
##### 4.测试生产者发送Route key为error的消息时
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20200316102613933.png)

 ![](..\static\笔记图片\RibbitMQ\image-20200316102627912.png)

##### 5.测试生产者发送Route key为info的消息时

![](..\static\笔记图片\RibbitMQ\image-20200316102925740.png)

 ![](..\static\笔记图片\RibbitMQ\image-20200316102947326.png)
...
![](..\static\笔记图片\RibbitMQ\image-20191127121900255.png)
...
##### 4.测试结果
 ...
 ![](..\static\笔记图片\RibbitMQ\image-20200316113935785.png)

 ![](..\static\笔记图片\RibbitMQ\image-20200316114000459.png)
...
- `串行方式:` 将注册信息写入数据库后,发送注册邮件,再发送注册短信,以上三个任务全部完成后才返回给客户端。 这有一个问题是,邮件,短信并不是必须的,它只是一个通知,而这种做法让客户端等待没有必要等待的东西. 
 ...
 ![](..\static\笔记图片\RibbitMQ\SouthEast-4860248.png)

- `并行方式: `将注册信息写入数据库后,发送邮件的同时,发送短信,以上三个任务完成后,返回给客户端,并行的方式能提高处理的时间。 

 ![](..\static\笔记图片\RibbitMQ\SouthEast-20191127211112660.png)

- `消息队列:`假设三个业务节点分别使用50ms,串行方式使用时间150ms,并行使用时间100ms。虽然并行已经提高的处理时间,但是,前面说过,邮件和短信对我正常的使用网站没有任何影响，客户端没有必要等着其发送完成才显示注册成功,应该是写入数据库后就返回.  `消息队列`: 引入消息队列后，把发送邮件,短信不是必须的业务逻辑异步处理 

  ![](..\static\笔记图片\RibbitMQ\592892-20190520220249900-1679743651.jpg)
...
`场景：双11是购物狂节,用户下单后,订单系统需要通知库存系统,传统的做法就是订单系统调用库存系统的接口. `
 ...
 ![](..\static\笔记图片\RibbitMQ\SouthEast-20191127211247287.png)

这种做法有一个缺点:

当库存系统出现故障时,订单就会失败。 订单系统和库存系统高耦合.  引入消息队列 

 ![](..\static\笔记图片\RibbitMQ\SouthEast-20191127211304085.png)
...
​			2.可以缓解短时间的高流量压垮应用(应用程序按自己的最大处理能力获取订单) 
 ...
 ![](..\static\笔记图片\RibbitMQ\SouthEast-20191127211341601.png)
...
![](..\static\笔记图片\RibbitMQ\image-20200320094147471.png)
...
2. ##### 集群搭建
   ...
   ![](..\static\笔记图片\RibbitMQ\image-20200320095613586.png)

   ```
   # 9.测试集群在node1上,创建队列
   ```

   ![](..\static\笔记图片\RibbitMQ\image-20200320095743935.png)

   ```
   # 10.查看node2和node3节点:
   ```

   ![](..\static\笔记图片\RibbitMQ\image-20200320095827688.png)

   ![](..\static\笔记图片\RibbitMQ\image-20200320095843370.png)
   ...
   ![](..\static\笔记图片\RibbitMQ\image-20200320100000347.png)

   ![](..\static\笔记图片\RibbitMQ\image-20200320100010968.png)
...
1. ##### 集群架构图
   ...
   ![](..\static\笔记图片\RibbitMQ\image-20200320113423235.png)
